...
class GroupStageTest{
	...
	void setUp(){
		date = LocalDate.now();
		team1 = new Team(new Gymnasium("gName1", "gCity1", Integer.MAX_VALUE), "tName1", DayOfWeek.MONDAY);
		team2 = new Team(new Gymnasium("gName2", "gCity2", Integer.MAX_VALUE), "tName2", DayOfWeek.MONDAY);
	...
	void addWrongMatch(){
		final var gs = new GroupStage("gs");
		gs.addAllTeams(List.of(team1, team2));
		final var wMatch1 = new Match(team1, new Team(new Gymnasium("gNameA", "gCityA", 2), "tNameA", DayOfWeek.MONDAY), team1.getGymnasium(), date);
		gs.addAllTeams(List.of(team1, team2));
